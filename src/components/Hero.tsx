    ...
    <section className="relative min-h-screen h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {images.map((image, index) => (
          <div
            key={index}
            className={`absolute inset-0 w-full h-[120vh] bg-cover bg-center bg-no-repeat scale-105 transition-opacity duration-2000 ${index === currentImageIndex ? 'opacity-100' : 'opacity-0'
              }`}
            style={{
      ...
      <div className="relative z-20 w-full h-full grid grid-rows-4 max-w-7xl mx-auto px-6 sm:px-8 safe-area-top">
        ...
        <div className="flex items-center justify-center pt-6 sm:pt-0">
          <div className={ctaReveal.className} ref={ctaReveal.ref}>
            <GlassCard variant="glass" intensity="high" className="p-6 sm:p-8 md:p-10 rounded-3xl hover:bg-white/15 transition-all duration-500 transform hover:scale-[1.02] relative z-30">
        ...
        <div className="flex items-start justify-center pt-6 sm:pt-3">
          <div className={trustReveal.className} ref={trustReveal.ref}>
            <GlassCard variant="glass" intensity="high" className="p-3 sm:p-4 rounded-2xl hover:bg-white/15 transition-all duration-500 relative z-30">
